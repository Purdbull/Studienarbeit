...
Die Konstruktion der dargestellten Komponenten wird wird in \ref{sec:getriebekonzept} beschrieben. 
...
Die Gondel soll stets lotrecht hängen. Vor allem beim Triebwagen ist der Aufbau durch den Motor stark einseitig belastet, wodurch sich ein Kippmoment ergibt. Mit einem Gewicht soll ein entgegengesetztes Drehmoment erzeugt werden. In \autoref{pic:kippmoment} ist der Zusammenhang veranschaulicht. 
...
Für die absolute Positionserfassung sollen entlang der Strecke Dauermagneten in einem Abstand von ca. 1,5m angebracht werden. Die Magneten schließen den Kontakt des  \acrshort{reed}-Schalters auf der Hochbahn. Je nach Fahrtrichtung inkrementiert bzw. dekrementiert dieses Signal einen Zähler auf dem Hochbahncontroller (ESP32). Auf Basis des Feedbacks der Motorsteuerung wird aus der aktuellen Geschwindigkeit die Position zwischen den Magneten berechnet. Die \acrshort{lagekopplung} ist prinzipbedingt fehlerbehaftet. Daher überschreibt die absolute Positionserfassung den Wert der Kopplung. 
