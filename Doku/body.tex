...
Auf der Bahn kommuniziert ein ESP32 mit dem Server und steuert gleichzeitig die Bahn. In den folgenden Abschnitten wird die Konzeption dieser einzelnen Softwareteilen erläutert.
\newpage
