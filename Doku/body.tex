...
\section{State Maschine}
Die State Maschine ist ein Klasse, welche die Zustandsübergänge verwaltet. Sie hat Zugriff auf emfangene Nachrichten und ruft jenachdem ob es eine neue Nachricht gibt die handle-Methode des aktuellen Zustands mit oder ohne byte-Parameter aus.
