...
\begin{figure}[h]
	...
	\end{center}
\end{figure}
%@moritz: Habe in der Word Vorschläge aufgeschrieben
...
%@moritz: Der Ablauf gilt ja generell für die Kommunikation und den beschreibst du ja auch vorher schon. Macht es dann nicht Sinn, den auch beim ESP schon zu erläutern? 
\begin{center}
	\begin{itemize}
...
\newpage 
\subsection{Regel 1: Maximalgeschwindigkeit einzelner Abschnitte}
...
Das Tablett welches an der Hochbahn befestigt ist, kann auf horizontaler Ebene schwingen. Ein solcher Schwingvorgang kann unter anderem durch schnelle Kurvenfahrten entstehen und sollte in möglichst allen Fällen vermieden werden. 
\subsection{Regel 2: Geschwindigkeit des vorletzten Abschnitts}
