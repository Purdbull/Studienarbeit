...
<div class="text-center">
    ...
    <div class="row">
        <div class="col mb-4" onclick="driveTo()"><button>Fahrbefehl senden</button></div>
    </div>
...
HTML bietet die Möglichkeit einer \texttt{onload-}MEthode. Diese wird ausgeführt, sobald die Seite aufgerufen wurde. Im Falle des Hochbahnservers initialisiert die \texttt{onload}-Methode die periodische Ausführung verschiedener GET-Requests. 
\subsubsection{Info}
