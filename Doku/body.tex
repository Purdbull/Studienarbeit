...
Für das Riemengetriebe werden zunächst die beiden Riemenräder ausgelegt. Es wird ein Zahnflachriemen mit einem äußeren Umfang von $U = 381mm$ und einer Riemenbreite von $b=9,5mm$ verwendet. Die Zähnezahl $z=75$. Folglich ist das Modul $m \approx 5$.  Die folgende Beschreibung der Abmaße des Riemenrades und des Laufrades sind das Ergebnis der gefertigten Prototypen.\\

 Für das Zahnrad gilt: $d_Z = \frac{m \cdot z}{\pi}$. Die Zähnezahl $z$ des Zahnrads wurde auf 22 festgelegt, dadurch ergibt sich $d_Z = 35,01 mm$. Entsprechend der Abmessungen des Riemens wurde der Durchmesser der Zahnflanken auf 2mm festgelegt. Für die seitliche Führung des Riemens wird ein Rand mit der Breite $b=3mm$ und dem Durchmesser $d=40mm$ einfügt. In \autoref{pic:riemenradZeichnung} ist die Zeichnung des Riemenrades dargestellt.  \\

\begin{figure}[h]
	\centering
	\includegraphics[width=9cm]{riemenradZeichnung.png}
	\caption{Technische Zeichnung des Riemenrades}
	\label{pic:riemenradZeichnung}
\end{figure}
...
Beim Laufrad beträgt der Durchmesser der Lauffläche 34mm. Für die Führung auf der Schiene besitzen die beiden äußeren Ränder eine Breite $b=3mm$ sowie einen Durchmesser $d=40mm$. \\

\underline{Implementierung des Getriebes}\\
Der äußere Umfang des Riemens beträgt $U = 381mm$. Für die Berechnung des Abstandes $\Delta$ der beiden Wellen zueinander gilt mit dem Riemenraddurchmesser $r$ folgende Formel: 

\begin{align}
	U = 2 (r+ \Delta) \\
	\Delta = \frac{U - 2r}{2} = \frac{381mm - 35,01}{2} \approx 173mm 
\end{align}
