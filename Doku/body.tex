...
\begin{center}
	...
	\end{itemize}
\end{center}
Der oben aufgelistete Ablauf ist fehlerlos dargestellt. Sofern Positionen nicht synchron sind oder falsche Befehle geschickt werden, würde er abgebrochen. Zur Kommunikation und genereller Steuerung der Software auf den Microcontrollern werden Zustandsautomaten verwendet. Der Gedanke war, dass ein Zustand nur eine gewissen Eingabe erwartet. So ist es möglich, dynamisch auf falsche Geschehnisse zu reagieren.
