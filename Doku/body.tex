...
Nach Verlöten der übrigen Komponenten und Anschluss von Step-Up-Wandler und Batterien konnte die Spannungsversorgung erfolgreich getestet werden. Dass die LEDs der Arduinos leuchten zeigt, dass kein Kurzschluss herrscht. Mit dem Multimeter konnten zudem alle Spannungen überprüft werden. In \autoref{pic:ecardLights} ist die fertig bestückte Platine im aktivierten Zustand gezeigt.
