...
Da das Deaktivieren des Motors aus dieser Geschwindigkeit zu abrupt wäre, werden bei der Minimalfrequenz die Schrittmodi gewechselt. Dazu wechselt der Motor sobald  das Flag \texttt{accDone} von der \acrshort{isr} gesetzt ist, in den Halbschrittmodus. Nach einer Wartezeit von einer Sekunde wird der Viertelschrittmodus aktiviert und nach einer weiteren Sekunde der Motor abgeschaltet. Bei der Einfahrt in die Ladestation wird der Motor in gleicher Weise verlangsamt mit dem Unterschied, dass dieser am Ende nicht deaktiviert wird. Für diesen letzten Schritt soll bei Erreichen des letzten \acrshort{reed}-Kontaktes der Motor mit Input 4 gezielt deaktiviert werden. 
