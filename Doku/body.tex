...
Im folgenden wird die zuvor unter \autoref{sec:stateESP} konzeptionierte Logik des Zustandsautomaten implementiert.
C++ ist die hierbei verwendete Programmiersprache. 

\section{Die State Klassen}

\section{Die State Maschine}
